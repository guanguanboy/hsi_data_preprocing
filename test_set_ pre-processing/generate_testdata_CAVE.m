...
dataset = 'CAVE';
upscale = 2;
savePath = ['D:/DataSets/hyperspectraldatasets/',dataset,'/test_processed/',num2str(upscale)];  % save test set  to "savePath"
if ~exist(savePath, 'dir')
    mkdir(savePath)
end

%% obtian all the original hyperspectral image
srPath = 'D:\DataSets\hyperspectraldatasets\CAVE\test';
